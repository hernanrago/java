...
public class SessionManager {
    ...
    private Configuration getConfiguration(){
        ...
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Pais.class);
        
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Presidente.class);
