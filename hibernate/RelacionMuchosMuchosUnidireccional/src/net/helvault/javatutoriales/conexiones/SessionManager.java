...
public class SessionManager {
    ...
    private Configuration getConfiguration(){
        ...
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Materia.class);
        
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Estudiante.class);
