...
public class SessionManager {
    ...
    private Configuration getConfiguration(){
        ...
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Persona.class);
        
        configuration.addAnnotatedClass(net.helvault.javatutoriales.entities.Direccion.class);
