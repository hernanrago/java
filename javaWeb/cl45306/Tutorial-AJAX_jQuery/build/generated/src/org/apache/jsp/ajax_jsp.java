...
public final class ajax_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <input type=\"text\" size=\"20\" id=\"idUsuario\" name=\"user\">\n");
      ...
      out.write("\n");
      out.write("                    $.ajax({\n");
      out.write("                        url: 'ValidadorDeUsuarios',\n");
      out.write("                        dataType: 'html',\n");
      out.write("                        data: {\n");
      out.write("                            id: $('#idUsuario').val()\n");
      out.write("                        },\n");
      out.write("                        success: function (responseText) {\n");
      out.write("                            if(\"true\"===responseText){\n");
      out.write("                                $('#spanRespuesta').css('color','red');\n");
      out.write("                                $('#spanRespuesta').html(\"Ese usuario ya existe.\");\n");
      out.write("                            } else{\n");
