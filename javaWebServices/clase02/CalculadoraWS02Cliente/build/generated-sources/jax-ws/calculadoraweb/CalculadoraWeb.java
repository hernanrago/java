...
public interface CalculadoraWeb {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "potenciar2", targetNamespace = "http://calculadoraweb/", className = "calculadoraweb.Potenciar2")
    @ResponseWrapper(localName = "potenciar2Response", targetNamespace = "http://calculadoraweb/", className = "calculadoraweb.Potenciar2Response")
    @Action(input = "http://calculadoraweb/CalculadoraWeb/potenciar2Request", output = "http://calculadoraweb/CalculadoraWeb/potenciar2Response")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "potenciar", targetNamespace = "http://calculadoraweb/", className = "calculadoraweb.Potenciar")
    @ResponseWrapper(localName = "potenciarResponse", targetNamespace = "http://calculadoraweb/", className = "calculadoraweb.PotenciarResponse")
    @Action(input = "http://calculadoraweb/CalculadoraWeb/potenciarRequest", output = "http://calculadoraweb/CalculadoraWeb/potenciarResponse")
