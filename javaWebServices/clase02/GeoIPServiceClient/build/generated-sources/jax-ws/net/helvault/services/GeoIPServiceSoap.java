...
public interface GeoIPServiceSoap {
     ...
     * @param ipAddress
     * @return
     *     returns net.helvault.services.GeoIP
     */
    ...
    @RequestWrapper(localName = "GetGeoIP", targetNamespace = "http://www.webservicex.net/", className = "net.helvault.services.GetGeoIP")
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "net.helvault.services.GetGeoIPResponse")
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "net.helvault.services.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "net.helvault.services.GetGeoIPContextResponse")
