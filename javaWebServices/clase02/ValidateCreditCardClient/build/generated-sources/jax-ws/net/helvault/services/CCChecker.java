    ...
    extends Service
{
     ...
     *     returns CCCheckerSoap
     */
    @WebEndpoint(name = "CCCheckerSoap12")
    public CCCheckerSoap getCCCheckerSoap12() {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerSoap12"), CCCheckerSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "CCCheckerSoap12")
    public CCCheckerSoap getCCCheckerSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerSoap12"), CCCheckerSoap.class, features);
    }

    /**
     * 
     * @return
     *     returns CCCheckerHttpGet
     */
    @WebEndpoint(name = "CCCheckerHttpGet")
    public CCCheckerHttpGet getCCCheckerHttpGet() {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerHttpGet"), CCCheckerHttpGet.class);
    }
     ...
     */
    @WebEndpoint(name = "CCCheckerHttpGet")
    public CCCheckerHttpGet getCCCheckerHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerHttpGet"), CCCheckerHttpGet.class, features);
    }

    /**
     * 
     * @return
     *     returns CCCheckerHttpPost
     */
    @WebEndpoint(name = "CCCheckerHttpPost")
    public CCCheckerHttpPost getCCCheckerHttpPost() {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerHttpPost"), CCCheckerHttpPost.class);
    }
     ...
     */
    @WebEndpoint(name = "CCCheckerHttpPost")
    public CCCheckerHttpPost getCCCheckerHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net", "CCCheckerHttpPost"), CCCheckerHttpPost.class, features);
    }
