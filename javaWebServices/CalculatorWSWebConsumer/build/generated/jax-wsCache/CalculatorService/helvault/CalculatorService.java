 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://helvault/", wsdlLocation = "http://localhost:8080/CalculatorWS/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://helvault/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorWS/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://helvault/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helvault/", "CalculatorPort"), Calculator.class, features);
    }
