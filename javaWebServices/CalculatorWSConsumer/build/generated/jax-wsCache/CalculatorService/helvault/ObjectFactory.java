 ...
 * generated in the helvault package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://helvault/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://helvault/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: helvault
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helvault/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://helvault/", name = "operationResponse")
